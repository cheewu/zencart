...
class nochex_apc extends base {
  ...
  function install() {
    global $db;
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('启用Nochex支付模块', 'MODULE_PAYMENT_NOCHEX_STATUS', 'True', 'Do you want to accept Nochex payments?', '6', '44', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Nochex 电子邮件地址', 'MODULE_PAYMENT_NOCHEX_EMAIL_ADDRESS','".STORE_OWNER_EMAIL_ADDRESS."', '您的Nochex帐号的电子邮件地址。<br />说明: 必须与您Nochex帐号的电子邮件地址<strong>完全一致</strong>。', '6', '44', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Nochex帐号类型', 'MODULE_PAYMENT_NOCHEX_ACCOUNT_TYPE', 'Seller', '请选择Nochex帐号的类型', '6', '44', 'zen_cfg_select_option(array(\'Seller\',\'Merchant\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('商户编号', 'MODULE_PAYMENT_NOCHEX_MERCHANT_ID', '', 'Nochex商户编号', '6', '44', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('付款地区', 'MODULE_PAYMENT_NOCHEX_ZONE', '0', '如果选择了付款地区，仅该地区可以使用该支付模块。', '6', '44', 'zen_get_zone_class_title', 'zen_cfg_pull_down_zone_classes(', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('等待订单状态', 'MODULE_PAYMENT_NOCHEX_PROCESSING_STATUS_ID', '" . DEFAULT_ORDERS_STATUS_ID .  "', '设置通过本支付模块付款，但还未完成的订单状态<br />(建议: \'等待中\')', '6', '44', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('订单状态', 'MODULE_PAYMENT_NOCHEX_ORDER_STATUS_ID', '2', '设置通过该支付方式付款的订单状态。<br />(建议: \'处理中\')', '6', '44', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('显示顺序', 'MODULE_PAYMENT_NOCHEX_SORT_ORDER', '0', '显示顺序：小的显示在前。', '6', '44', now())");
