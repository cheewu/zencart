...
//2010-9-17$payment_modules->before_process();
...
//2010-9-17$payment_modules->after_order_create($insert_id);

$zco_notifier->notify('NOTIFY_CHECKOUT_PROCESS_AFTER_PAYMENT_MODULES_AFTER_ORDER_CREATE');
$_SESSION['order_number_created'] = $insert_id;
$zco_notifier->notify('NOTIFY_CHECKOUT_PROCESS_AFTER_ORDER_CREATE_ADD_PRODUCTS');//die('asdf');
//send email notifications
//2010-9-17
//$$payment_modules->set_email_information();
//$order->send_order_email($insert_id, 2);
$zco_notifier->notify('NOTIFY_CHECKOUT_PROCESS_AFTER_SEND_ORDER_EMAIL');

$_SESSION['cart']->reset(true);  //---�����ٴ�����¹��ﳵ
...
//2010-9-17$payment_modules->after_process();
