...
if(isset($_COOKIE['users_email_address']) && $_COOKIE['users_email_address']!='')
{
	$users_email_address=$_COOKIE['users_email_address'];
}
if(isset($_COOKIE['users_email_password']) && $_COOKIE['users_email_password']!='')
{
	$users_email_password=$_COOKIE['users_email_password'];
}
$error = false;
