...
<div style="color:red; text-align:left;"><?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?></div>
<address style="line-height: 25px"><?php echo zen_billing_address_label($_SESSION['customer_id'], $_SESSION['billto'], true, ' ', '<br />'); ?></address>
<br class="clearBoth" />
<?php
?>
<?php
...
?>
<?php
    if (false && $addresses_count > 1) { //---------- 对于billing地址,这里就不再让他去选择其他地址了
?>
<fieldset>
