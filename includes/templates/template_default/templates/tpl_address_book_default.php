...
<?php require($template->get_template_dir('tpl_account_box.php',DIR_WS_TEMPLATE, $current_page_base,'sideboxes'). '/tpl_account_box.php');?>
    ...
    <td class="myaccountright" valign="top" rowspan="3">
...
?>
<div class="buttonRow back"><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div></td>
  </tr>
