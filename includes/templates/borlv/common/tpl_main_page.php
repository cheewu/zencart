...
<body id="<?php echo $body_id . 'Body'; ?>"<?php if($zv_onload !='') echo ' onload="'.$zv_onload.'"'; ?>>
   ...
   <?php if($this_is_home_page) {?>
    <div class="banner"><img src="<?=$zen->urlTplImg('banner.jpg');?>" width="980" height="333" /></div>
	<?php }?>
...
<?php
/*
  if (CUSTOMERS_APPROVAL_AUTHORIZATION == 1 && CUSTOMERS_AUTHORIZATION_HEADER_OFF == 'true' and ($_SESSION['customers_authorization'] != 0 or $_SESSION['customer_id'] == '')) { $flag_disable_header = true; }
...
<div class="smallText center">
	<?php echo TEXT_PARSE_TIME;?>: <?php echo $parse_time; ?> - <?php echo TEXT_NUMBER_OF_QUERIES;?>: <?php echo $db->queryCount(); ?> - <?php echo TEXT_QUERY_TIME;?>: <?php echo $db->queryTime(); ?>
</div>
<?php
  } ?>
