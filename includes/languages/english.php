...
define('TABLE_PRODUCT_VIEW', 'View');
define('TABLE_PRODUCT_GRID', 'Grid');
define('TABLE_PRODUCT_GALLERY', 'Gallery');
define('TABLE_PRODUCT_LIST', 'list');
define('TABLE_PRODUCT_ALL', 'ALL');
define('TABLE_PRODUCT_SORTED_BY', 'Sorted By');
define('TABLE_PRODUCT_SHOW', 'Show');
define('TABLE_PRODUCT_VIEW_LARGER_IMAGE', 'View Larger Image');
define('TABLE_LOGIN_PROFILE', 'Login profile');
define('TABLE_NEW_LOGIN_PROFILE', 'New User,Please create a login profile');
define('TEXT_BILLING_SHIPPING', 'My billing address is the same as my shipping address.');
define('TEXT_YES', 'YES');
define('TEXT_NO', 'NO');
...
define('TEXT_SIDEBOXES_VIEWED', 'Viewed');
define('TEXT_ORDER_DES', "Thanks for your purchase! Your Order Number <span style='checkoutSuccessHeading_1_a'>%s</span> has been generated, please click the button below to make the payment with the <span style='checkoutSuccessHeading_1_b'>%s</span> ,and we'll send the order out using <span style='checkoutSuccessHeading_1_c'>%s</span> when payment is confirmed.");

define('TEXT_ORDER_DES1', "Thanks for your purchase! Your Order Number <span style='checkoutSuccessHeading_1_a'>%s</span> has been generated, please check your email(also spam box) to recevie the necessary information to make payment by <span style='checkoutSuccessHeading_1_a'>%s</span>,and we'll send the order out using <span style='checkoutSuccessHeading_1_a'>%s</span> when payment is confirmed.<br /> Go To <a style='color:red' href='".zen_href_link(FILENAME_ACCOUNT, '', 'SSL')."'>My Account</a>");
...
define('BOX_INFORMATION_SHIPPING', 'FREE SHIPPING AND REFUND');
...
define('BOX_HEADING_TELL_A_FRIEND', 'Newsletter');
define('BOX_TELL_A_FRIEND_TEXT', '<strong>Subscribe to our free e-newsletter, and get new tips every two weeks.</strong>');
...
define('NEW_SHIPPING_ADDRESS_TITLE','Shipping Address');//---------- ,ͻַ
...
define('ENTRY_NEWSLETTER', 'Our Newsletter.');
...
define('TEXT_START_FROM','Start From');
define('TEXT_DESCRIPTION','Description');
define('TEXT_PARSE_TIME','Parse Time');
define('TEXT_NUMBER_OF_QUERIES','Number of Queries');
define('TEXT_QUERY_TIME','Query Time');
define('TEXT_WELCOME','Welcome!');
define('TEXT_REGISTER','Register');
define('TEXT_OR','or');
define('TEXT_OUR_PRICE','Our Price');
define('TEXT_STYLE','STYLE');
define('TEXT_FORGOT_YOUR_PASSWORD','Forgot your password');
...
define('IN_SAME_CATEGORY','In Same Category');
define('SALE_PRICE','Sale Price :');

define('MY_ACCOUNT_ORDERS_TITLE', 'View Orders');
define('MY_ACCOUNT_TITLE', 'My Account');
define('MY_ACCOUNT_INFORMATION', 'Account Settings');
define('MY_ACCOUNT_ADDRESS_BOOK', 'Manage Address Book');
define('MY_ACCOUNT_PASSWORD', 'Change your password');
define('MY_X_TELL_A_FRIEND','Tell A Friend');
define('MY_I_RECOMMEND','My Friend');

define('OPENID_EMAIL_MESSAGE','Please provide us with your email so that we can contact you.');

define('TPL_EZPAGES_BAR_FOOTER_CONDITIONS','Conditions of Use');
define('TPL_EZPAGES_BAR_FOOTER_PAYMENT','Payment');
define('TPL_EZPAGES_BAR_FOOTER_SHIPPINGINFO','FREE SHIPPING AND REFUND');
define('TPL_EZPAGES_BAR_FOOTER_PRIVACY','Privacy');
define('TPL_EZPAGES_BAR_FOOTER_SITE_MAP','Site Map');
define('TPL_EZPAGES_BAR_FOOTER_CONTACT_US','Contact Us');
define('TPL_EZPAGES_BAR_FOOTER_OUR_PARTNERS_LINKS','Our Partners Links');

define('TPL_EZPAGES_BAR_HEADER_HOME','Home');
define('TPL_EZPAGES_BAR_HEADER_PRODUCTS_NEW','New Products');
define('TPL_EZPAGES_BAR_HEADER_FEATURED_PRODUCTS','Featured Products');
define('TPL_EZPAGES_BAR_HEADER_CONTACT_US','Contact Us');
define('TPL_EZPAGES_BAR_HEADER_FAQ','FAQ');
