...
define('MY_EMAIL_ALSO', '<font color=red>You may send </font> <strong>'.zen_href_link(FILENAME_CREATE_ACCOUNT,'ref=%s').'</strong> <font color=red>to your friends</font>');

define('HEADING_TITLE', 'Tell A Friend');
