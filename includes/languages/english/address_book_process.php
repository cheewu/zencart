...
define('ERROR_ADDRESS_NOTICE', 'notice:');
...
define('MY_ACCOUNT_INFORMATION', 'Account Settings');//View or change my account information.
define('MY_ACCOUNT_ADDRESS_BOOK', 'Manage Address Book');//View or change entries in my address book.
define('MY_ACCOUNT_PASSWORD', 'Change your password');//Change my account password.
