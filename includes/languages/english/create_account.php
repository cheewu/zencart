...
define('EMAIL_GREET_MR', '<p><strong>Dear Customer:</strong></p>' . "\n\n");
define('EMAIL_GREET_MS', '<p><strong>Dear Customer:</strong></p>' . "\n\n");
define('EMAIL_GREET_NONE', '<p><strong>Dear Customer:</strong></p>' . "\n\n");

// First line of the greeting
define('EMAIL_WELCOME', 'We wish to welcome you to <a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">' . LOCAL_SITE . '</a> and the account you just set up allows you to securely store all your ordering information, so that your purchase on <a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">' . LOCAL_SITE . '</a>  is simple and safe as well as much pleasures.');
