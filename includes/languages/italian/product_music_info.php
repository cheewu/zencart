 ...
 * @version $Id: product_music_info.php 3027 2006-02-13 17:15:51Z Albigin $
 */

define('TEXT_PRODUCT_NOT_FOUND', 'Spiacenti, non abbiamo trovato il prodotto.');
define('TEXT_CURRENT_REVIEWS', 'Recensioni attuali:');
define('TEXT_RECORD_COMPANY_URL', 'Per maggiori informazioni, visita il sito della Casa Discografica <a href="%s" target="_blank">pagina web</a>.');
define('TEXT_ARTIST_URL', 'Per maggiori informazioni, visita il sito dell\'Artista <a href="%s" target="_blank">pagina web</a>.');
