 ...
 * @version $Id: product_free_shipping_info.php 3027 2006-02-13 17:15:51Z Albigin $
 */

define('TEXT_PRODUCT_NOT_FOUND', 'Spiacenti, non abbiamo trovato l\'articolo.');
define('TEXT_CURRENT_REVIEWS', 'Recensioni attuali:');
define('TEXT_MORE_INFORMATION', 'Per maggiori informazioni, puoi visitare la seguente <a href="%s" target="_blank">pagina web</a>.');
define('TEXT_DATE_ADDED', 'Articolo inserito in catalogo il %s.');
define('TEXT_DATE_AVAILABLE', '<font color="#ff0000">Articolo disponibile dal %s.</font>');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Clienti che hanno acquistato questo articolo hanno comprato anche...');
