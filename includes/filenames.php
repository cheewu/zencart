...
define('FILENAME_CHECKOUT_PAYMENT', 'checkout_shipping');
...
define('FILENAME_X_TELL_A_FRIEND', 'x_tell_a_friend');
define('FILENAME_IRECOMMEND', 'irecommend');
...
define('FILENAME_CHECKOUT_ORDERS', 'checkout_orders.php');
