...
<!-- body_text //-->
  ...
  WHOS_ONLINE_INACTIVE_LAST_CLICK_TEXT . '&nbsp;' . WHOIS_TIMER_INACTIVE . '秒' .
  '&nbsp;||&nbsp;' . WHOS_ONLINE_INACTIVE_ARRIVAL_TEXT . '&nbsp;' .
  WHOIS_TIMER_DEAD . '秒&nbsp;' . WHOS_ONLINE_REMOVED_TEXT;
            ?>
            </td>
          </tr>
          <tr>
            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRowWhois">
                ...
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=full_name"; ?>"><?php echo ($listing=='full_name' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=full_name-desc"; ?>"><?php echo ($listing=='full_name-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=ip_address"; ?>"><?php echo ($listing=='ip_address' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=ip_address-desc"; ?>"><?php echo ($listing=='ip_address-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=session_id"; ?>"><?php echo ($listing=='session_id' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=session_id-desc"; ?>"><?php echo ($listing=='session_id-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=time_entry"; ?>"><?php echo ($listing=='time_entry' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=time_entry-desc"; ?>"><?php echo ($listing=='time_entry-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=time_last_click"; ?>"><?php echo ($listing=='time_last_click' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=time_last_click-desc"; ?>"><?php echo ($listing=='time_last_click-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
                <td class="dataTableHeadingContentWhois" align="center">
                  ...
                  <br><a href="<?php echo "$PHP_SELF?listing=last_page_url"; ?>"><?php echo ($listing=='last_page_url' ? '<span class="dataTableHeadingContentWhois">' . '升序' . '</span>' : '<b>' . '升序' . '</b>'); ?></a>&nbsp;
                  &nbsp;<a href="<?php echo "$PHP_SELF?listing=last_page_url-desc"; ?>"><?php echo ($listing=='last_page_url-desc' ? '<span class="dataTableHeadingContentWhois">' . '降序' . '</span>' : '<b>' . '降序' . '</b>'); ?></a>&nbsp;
                </td>
              </tr>
<?php
  $ip_array = array();
...
?>
                <td class="dataTableContentWhois" colspan=3 valign="top">&nbsp;&nbsp;<?php echo TIME_PASSED_LAST_CLICKED . '<br />&nbsp;&nbsp;&nbsp;&nbsp;' . zen_check_minutes($whos_online->fields['time_last_click']); ?> 之前</td>
...
?>
              <tr>
                <td class="smallText" colspan="8">图例: <?php echo zen_image(DIR_WS_IMAGES . 'icon_status_green.gif') . "在线/有购物车&nbsp;&nbsp;" . zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif') . "离开/有购物车&nbsp;&nbsp;" . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif') . "在线/没有购物车&nbsp;&nbsp;" .  zen_image(DIR_WS_IMAGES . 'icon_status_red_light.gif') . "离开/没有购物车" . "<br>离开指最后的点击时间超过" . WHOIS_TIMER_INACTIVE . "秒" . " &nbsp; || 如果离开时间超过" . WHOIS_TIMER_DEAD . "秒将被删除";?></td>
              </tr>
<?php
  }
?>
              <tr>
                <td class="smallText" colspan="8"><?php echo sprintf(TEXT_NUMBER_OF_CUSTOMERS, $total_sess); print "<br>重复的IP地址: $total_dupes<br>实际客户数: $total_cust.";?></td>
              </tr>
            </table></td>
<?php
  $heading = array();
