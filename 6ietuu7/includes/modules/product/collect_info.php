...
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      ...
      //-------------- 添加products_image里的图片
      $product_image = $db->execute("select products_image from products_image where products_id = '" . (int)$_GET['pID'] . "'");
      $ii = 1;
      while(!$product_image->EOF) {
        $nn = "products_image$ii";
        $pInfo->$nn = $product_image->fields['products_image'];
        $product_image->MoveNext();
        $ii++;
      }
...
?>
        ...
        <!--   添加多图bof  -->
        <tr>
                <td class="main"><?php echo '描述里的图片1:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image1') . '&nbsp;' . ($pInfo->products_image1 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image1 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image1', $pInfo->products_image1); ?></td>
                <td valign = "center" class="main"></td>
        </tr>   
        <tr>
                <td class="main"><?php echo '描述里的图片2:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image2') . '&nbsp;' . ($pInfo->products_image2 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image2 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image2', $pInfo->products_image2); ?></td>
                <td valign = "center" class="main"></td>
        </tr> 
        <tr>
                <td class="main"><?php echo '描述里的图片3:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image3') . '&nbsp;' . ($pInfo->products_image3 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image3 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image3', $pInfo->products_image3); ?></td>
                <td valign = "center" class="main"></td>
        </tr> 
        <tr>
                <td class="main"><?php echo '描述里的图片4:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image4') . '&nbsp;' . ($pInfo->products_image4 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image4 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image4', $pInfo->products_image4); ?></td>
                <td valign = "center" class="main"></td>
        </tr> 
        <tr>
                <td class="main"><?php echo '描述里的图片5:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image5') . '&nbsp;' . ($pInfo->products_image5 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image5 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image5', $pInfo->products_image5); ?></td>
                <td valign = "center" class="main"></td>
        </tr> 
        <tr>
                <td class="main"><?php echo '描述里的图片6:'; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('products_image6') . '&nbsp;' . ($pInfo->products_image6 !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image6 : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image6', $pInfo->products_image6); ?></td>
                <td valign = "center" class="main"></td>
        </tr>      
        <!--   添加多图eof  -->
              <tr>
