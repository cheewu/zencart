...
define('TEXT_INFO_HEADING_DELETE_FEATURED', '删除最新商品');
define('TEXT_INFO_DELETE_INTRO', '你确定要删除最新商品?');

define('SUCCESS_FEATURED_PRE_ADD', '成功: 预添加最新商品 ... 请更新日期 ...');
...
define('TEXT_INFO_HEADING_PRE_ADD_FEATURED', '按商品编号添加最新商品');
define('TEXT_INFO_PRE_ADD_INTRO', '如果数据库比较大，可以通过商品编号手工添加最新商品');
define('TEXT_PRE_ADD_PRODUCTS_ID', '请输入预添加商品编号: ');
define('TEXT_INFO_MANUAL', '手工添加最新商品的编号');
?>